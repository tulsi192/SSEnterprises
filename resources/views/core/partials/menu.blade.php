            ...
            <div class="collapse navbar-collapse" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                    ...
                    <li class="nav-item d-none d-md-block"><a class="nav-link nav-link-expand" href="#"
                            title="Press F11 or Fn+F11 to Get Full Screen"
                            alt="Press F11 or Fn+F11 to Get Full Screen"><i class="ficon ft-maximize"></i></a></li>
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label"
                            ...
                            @else
                                ...
                                <span class="badge badge-pill badge-danger badge-up"> {{ trans('general.off') }}</span>
                            @endif
                        </a>
    ...
    <div class="navbar-container main-menu-content" data-menu="menu-container">
        ...
        <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    @permission('invoice-create')
                                        <li><a class="dropdown-item" href="{{ route('biller.invoices.create') }}"
                                                ...
                                                {{ trans('labels.backend.invoices.create') }}
                                            </a>
                                    </li> @endauth
                                    <li><a class="dropdown-item" href="{{ route('biller.invoices.index') }}?md=pos"
                                            data-toggle="dropdown"><i class="ft-zap"></i>
                                            {{ trans('labels.backend.invoices.pos_management') }}
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('biller.quotes.index') }}"
                                            data-toggle="dropdown"><i class="ft-file-text"></i>
                                            {{ trans('quotes.management') }}
                                        </a>
                                    </li>
                                    <li><a class="dropdown-item" href="{{ route('biller.quotes.create') }}"
                                            data-toggle="dropdown"><i class="fa fa-plus-circle"></i>
                                            {{ trans('labels.backend.quotes.create') }}
                                        </a>
                                    </li>
                                </ul>
                            </li>
            ...
            @if (access()->allow('product-manage') ||
                    access()->allow('purchaseorder-manage') ||
                    access()->allow('manage-warehouse') ||
                    access()->allow('supplier-manage'))
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link"
                        href="#" data-toggle="dropdown"><i
                    ...
                    <ul class="dropdown-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    @permission('product-create')
                                        <li><a class="dropdown-item" href="{{ route('biller.products.create') }}"
                                                data-toggle="dropdown"> <i class="fa fa-plus-circle"></i>
                                                {{ trans('labels.backend.products.create') }}
                                            </a>
                                        </li>
                                    @endauth
                                </ul>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    @permission('warehouse-data')
                                        <li><a class="dropdown-item" href="{{ route('biller.warehouses.create') }}"
                                                data-toggle="dropdown"> <i class="fa fa-plus-circle"></i>
                                                {{ trans('labels.backend.warehouses.create') }}
                                            </a>
                                        </li>
                                    @endauth
                                </ul>
                            ...
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item"
                                            ...
                                            data-toggle="dropdown"><i class="ft-file-text"></i>
                                            {{ trans('orders.stock_return_manage') }}
                                        </a>
                                    </li>
                                    @permission('stockreturn-data')
                                        <li><a class="dropdown-item"
                                                ...
                                                data-toggle="dropdown"><i class="fa fa-plus-circle"></i>
                                                {{ trans('orders.stock_return_create') }}
                                            </a>
                                        </li>
                                    @endauth
                                </ul>
                            ...
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('biller.products.product_label') }}"
                                            data-toggle="dropdown"> <i class="ft-list"></i>
                                            {{ trans('products.product_label_print') }}
                                        </a>
                                    </li>
                                    <li><a class="dropdown-item" href="{{ route('biller.products.standard') }}"
                                            data-toggle="dropdown"> <i class="ft-list"></i>
                                            {{ trans('products.standard_sheet') }}
                                        </a>
                                    </li>
                                </ul>
                            </li>
                        ...
                        @permission('stocktransfer')
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item "
                                    href="{{ route('biller.products.stock_transfer') }}"><i class="ft-wind"></i>
                                    {{ trans('products.stock_transfer') }}</a>
                            ...
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item"
                                            ...
                                            data-toggle="dropdown"> <i class="fa fa-columns"></i>
                                            {{ trans('accounts.balance_sheet') }}</a>
                                    </li>
                                    @permission('account-data')
                                        <li><a class="dropdown-item" href="{{ route('biller.accounts.create') }}"
                                                data-toggle="dropdown"> <i class="fa fa-plus-circle"></i>
                                                {{ trans('labels.backend.accounts.create') }}
                                            </a>
                                        </li>
                                    @endauth
                                </ul>
                                            ...
                                            <ul class="mega-menu-sub">
                                                ...
                                                <li><a class="dropdown-item"
                                                        href="{{ route('biller.reports.statements', ['income']) }}"><i
                                                            class="icon-doc"></i>
                                                        {{ trans('meta.income_statement') }}</a>
                                                </li>
                                                <li><a class="dropdown-item"
                                                        href="{{ route('biller.reports.statements', ['expense']) }}"><i
                                                            class="icon-doc"></i>
                                                        {{ trans('meta.expense_statement') }}</a>
                                                </li>
                                                <li><a class="dropdown-item"
                                                        href="{{ route('biller.reports.statements', ['profit']) }}"><i
                                                            class="icon-doc"></i> {{ trans('en.profit_statement') }}</a>
                                                </li>
                                                <li><a class="dropdown-item"
                                                        href="{{ route('biller.reports.statements', ['transaction']) }}"><i
                                                            class="icon-doc"></i>
                                                        {{ trans('en.transaction_category_statement') }}</a>
                                                </li>
                                                <li><a class="dropdown-item"
                                                ...
                                                <li><a class="dropdown-item"
                                                        href="{{ route('biller.reports.statements', ['market_statement']) }}"><i
                                                            class="icon-doc"></i>
                                                        {{ trans('sales_channel.sales_channel_statement') }}</a>
                                                </li>
                                            </ul>
                                        </li>
                                    ...
                                    <ul class="mega-menu-sub">
                                        ...
                                        <li data-menu=""><a class="dropdown-item"
                                                href="{{ route('biller.reports.charts', ['supplier']) }}"><i
                                                    class="fa fa-sun-o"></i>
                                                {{ trans('meta.supplier_graphical_overview') }}
                                            </a>
                                        </li>
                                        <li data-menu=""><a class="dropdown-item"
                                    ...
                                    <ul class="mega-menu-sub">
                                        ...
                                        <li data-menu=""><a class="dropdown-item"
                                                href="{{ route('biller.reports.summary', ['expense']) }}"><i
                                                    class="fa fa fa-bullhorn"></i>
                                                {{ trans('meta.expense_summary') }}</a>
                                        </li>
                                        <li data-menu=""><a class="dropdown-item"
                            ...
                            <ul class="drilldown-menu">
                                <li class="menu-list">
                                    <ul class="mega-menu-sub">
                                        ...
                                        <li><a class="dropdown-item"
                                                href="{{ route('biller.import.general', ['customer']) }}"><i
                                                    class="fa fa-file-excel-o"></i>
                                                {{ trans('import.import_customers') }}
                                            </a>
                                        </li>
                                        <li><a class="dropdown-item"
                                                href="{{ route('biller.import.general', ['products']) }}"><i
                                                    class="fa fa-file-excel-o"></i> {{ trans('import.import_products') }}
                                            </a>
                                        </li>
                                        <li><a class="dropdown-item"
                                                href="{{ route('biller.import.general', ['accounts']) }}"><i
                                                    class="fa fa-file-excel-o"></i> {{ trans('import.import_accounts') }}
                                            </a>
                                        </li>
                                        <li><a class="dropdown-item"
                                                href="{{ route('biller.import.general', ['transactions']) }}"><i
                                                    class="fa fa-file-excel-o"></i>
                                                {{ trans('import.import_transactions') }}
                                            </a>
                                        </li>
