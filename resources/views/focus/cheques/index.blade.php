...
@section ('title', trans('labels.backend.cheques.management'))

@section('page-header')
    <h1>{{ trans('labels.backend.cheques.management') }}</h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">{{ trans('labels.backend.cheques.management') }}</h4>
...
@section('after-scripts')
    ...
    <script>
        $(function () {
            ...
            $('#banks-table_wrapper').removeClass('form-inline');
