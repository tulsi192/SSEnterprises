...
@section ('title', trans('labels.backend.routes.management') . ' | ' . trans('labels.backend.routes.edit'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.routes.management') }}
        <small>{{ trans('routes.edit') }}</small>
    </h1>
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h4 class="content-header-title mb-0">{{  trans('routes.edit') }}</h4>
