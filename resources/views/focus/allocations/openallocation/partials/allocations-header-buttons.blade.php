<div class="">
    <div class="btn-group" role="group" aria-label="routes">
        <a href="{{ route('biller.allocations.index') }}" class="btn btn-info  btn-lighten-2 round"><i
                class="fa fa-list-alt"></i> {{ trans('general.list') }}</a>
        @permission('create-route')
            <a href="{{ route('biller.allocations.create') }}" class="btn btn-pink  btn-lighten-3 round"><i
