        ...
        <form method="post" class="tabs-wrap" id="install">
            ...
            <div class="tab" id="tab4content">
                ...
                <div class="form-group {{ $errors->has('user_email') ? ' has-error ' : '' }}">
                    ...
                    <input type="email" name="user_email" id="user_email" class="form-control" value="superadmin@example.com"
                ...
                <div class="form-group {{ $errors->has('purchase_code') ? ' has-error ' : '' }}">
                    <label for="database_hostname">
                        {{ trans('installer_messages.environment.wizard.form.purchase_code') }} | <a style="color:red;" href="https://cutt.ly/PLFZenO" target="_blank">NULLED Web Community</a></small>
                    </label>
